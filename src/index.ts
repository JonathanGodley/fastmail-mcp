        ...
        inputSchema: {
          ...
          properties: {
            ...
            replyTo: {
              type: 'array',
              items: { type: 'string' },
              description: 'Updated Reply-To email addresses (optional)',
            },
          },
          required: ['emailId'],
        },
        ...
        inputSchema: {
          ...
          properties: {
            ...
            savePath: {
              type: 'string',
              description: process.env.FASTMAIL_ALLOW_ANY_PATH === 'true'
                ? 'File path to save the attachment to. Parent directories are created automatically.'
                : 'Filename or path within ~/Downloads/fastmail-mcp/ (e.g. "report.pdf" or "2026/march/report.pdf"). Directories are created automatically.',
            },
          },
