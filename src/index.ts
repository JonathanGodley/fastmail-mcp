...
// move to Trash drops), and so does the send that files a draft into Sent, which send_draft's
// own description spells out. This constant is the warning for the two
